...
public class Main {
  public static void main(String[] args) {
	...
	try {
		System.out.println("File info = " + Main.class.getResource("/home/pi/Robot2017/config.properties"));
		...
		teamnumber = Integer.parseInt(configFile.getProperty("teamnumber"));
		inputstreamport = Integer.parseInt(configFile.getProperty("inputstreamport"));
		networktablename = configFile.getProperty("networktablename");
		cameraip = configFile.getProperty("cameraip");
		...
		System.out.println("Cannot Get The config.properties file");
		e.printStackTrace();
	}
